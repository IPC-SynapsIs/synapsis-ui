...
import { Environments, InjectableDependency } from './synapsis.config.interfaces';
...
/**
 * This class represents the basic configuration of the synapsis.
...
export class SynapsisConfig {
  ...
  */
  ...
  /**
   * The directory of the tasks provided by the synapsis.
   */
  SYNAPSIS_TASKS_DIR = join(process.cwd(), this.TOOLS_DIR, 'tasks', 'synapsis');
